...
namespace Input
{
	namespace Data 
	{
		extern std::array<bool, KEY_LAST> key_down_data;
		extern std::array<bool, KEY_LAST> key_pressed_data;
		extern std::array<bool, KEY_LAST> key_release_data;
		extern std::array<bool, MOUSE_BUTTON_LAST> mouse_buttom_pressed_data;
		extern std::array<bool, MOUSE_BUTTON_LAST> mouse_buttom_release_data;
